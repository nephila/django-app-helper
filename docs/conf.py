...
import helper  # isort:skip  # noqa
import app_helper  # isort:skip  # noqa
# fmt: on
...
version = LooseVersion(app_helper.__version__).vstring.rpartition(".")[0]
# The full version, including alpha/beta/rc tags.
release = app_helper.__version__
...
latex_documents = [
    ("index", "DjangoAppHelperr.tex", "Django App Helper Documentation", "Iacopo Spalletti", "manual"),
]
...
man_pages = [("index", "DjangoAppHelperr", "Django App Helper Documentation", ["Iacopo Spalletti"], 1)]
