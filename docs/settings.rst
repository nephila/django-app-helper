###############################
Settings with Django App Helper
###############################
...
Extra settings can be provided by creating a ``app_helper.py`` file in the application root
...
By default any setting option provided in ``app_helper.py`` will override the default ones.
